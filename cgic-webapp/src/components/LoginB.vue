<template>
  <div id="login">
    <img id="login-bmg" src="../assets/bmg02.jpg"/>
        ...
        <el-form ref="loginForm" :model="loginForm" label-position="right" label-width="auto"
          ...
          <el-form-item prop="loginName">
            <el-col :span="18" :offset="3">
              <el-input type="text" placeholder="用户名" @input="userChange" v-model="loginForm.loginName"
                        @keyup.enter.native="loginSubmit"></el-input>
            </el-col>
          </el-form-item>
          <el-form-item prop="loginPassword">
            <el-col :span="18" :offset="3">
              <el-input type="password" placeholder="密码" @input="userChange" v-model="loginForm.loginPassword"
                        @keyup.enter.native="loginSubmit"></el-input>
            </el-col>
...
//  import { getToken, getUserDetail } from '@/api/login-api'
